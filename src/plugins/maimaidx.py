...
[@我]<出勤店铺><人数/几>人                                             设置或者显示当前店铺的出勤人数（暂未设置）
...
我要在<等级>上<分值>分                                                   鱼油的锦囊 - 快速推荐上分歌曲。

查看排名/查看排行                                                               查看查分器网站 Rating 的 TOP50 排行榜！

底分分析/rating分析 <用户名>                                           Best 40 的底分分析

早/[上午/中午/晚上]好/签到                                                             进行一波签到，然后可以得到今天的运势歌曲。（暂不可用）
------------------------------------------------------------------------------------------------------------------------------
